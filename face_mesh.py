...
class FaceMesh(object):
    ...
    def get_eye_landmarks(self, landmarks):
        ...
        if len(landmarks) > 0:
            # reference：https://github.com/tensorflow/tfjs-models/blob/master/facemesh/mesh_map.jpg
            # left eye
